...
#define STRING_CONFIG_H_AUTHOR "Slasher006" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100.7, 100.7, 2500, 97 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 30, -42, 0 }
